...
public class AccountServiceMain {
	public static void main(String[] args) {
		...
		accountService.addAccount(1000, "SIM", 35000, 3.4);
		...
		accountService.ipGum(3333, 20000);
		accountService.findByNoPrint(3333); // 확인용
		System.out.println("9.AccountService객체야 계좌번호,출금할돈 인자로줄께 출금해줘");
		accountService.chulGum(7777, 30000);
		accountService.findByNoPrint(7777); // 확인용
