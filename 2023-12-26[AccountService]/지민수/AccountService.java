...
import com.itwill00.variable.ForGugudan;
	 ...
	 */
		...
		*/
		...
		public AccountService() {
			...
			accounts[0]=new Account(1111, "KIM", 69000, 1.3);
			...
			accounts[6]=new Account(7777, "KIM", 59000, 4.7);
		...
		*/
		...
		public void totAccountNumberPrint() {
			...
			System.out.println("총 계좌 수 : "+count);
		}
		/*
		 * 2.은행계좌들 전체출력메쏘드 정의
		 */
		...
		public void totBalancePrint() {	
			...
			System.out.println("계좌 총 잔고 : "+count); 
