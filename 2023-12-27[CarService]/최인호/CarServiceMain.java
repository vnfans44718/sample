...
public class CarServiceMain {
	public static void main(String[] args) {
		...
		System.out.println("전체주차구획수 : "+carService.getTotalParkingNumber());
		System.out.println("3.CarService객체야 주차가능주차구획수반환해줘");
		System.out.println("주차가능구획수 : "+carService.getAvailableParkingNumber());
		System.out.println("4.CarService객체야 차량번호(2322번) 인자로줄께  차객체한대 참조변수반환해줘");
		System.out.println(carService.findByNo("2322"));
		System.out.println("5.CarService객체야 입차시간(8시이후) 인자로줄께 차객체배열 참조변수반환해줘");
		System.out.println(carService.findByInTime(8));
		carService.print();
