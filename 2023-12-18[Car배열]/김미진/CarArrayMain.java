...
public class CarArrayMain { //주차타워
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < carArray.length; i++) {
			if(carArray[i] != null && carArray[i].getOutTime() >= 10) {
				carArray[i].print();
			}
		...
		/*
		 * 1. 2389번차량찾기 - 배열 돌리기
		 * 2. 출차 - 기존 주차장에서 제거(아웃타임 세팅)
		 * 3. 영수증출력 (요금 계산)
		 * 4. 2389번차량 주차장에서 차량삭제 - null로 세팅
		 	carArray[21]=null;
		 */
		carArray[21]=null;
