...
//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ		
		...
		Account addAccount = new Account(1000, "고소영", 89000, 0.5);//객체를 만들었다.
		  
		boolean isAdd = accountServiceArrayList.addAccount(addAccount); //add메서드를 초기화함
		
		if(isAdd) {// isAdd는 addAccount가 반환하는 true 또는 false다
			
			System.out.println("account추가성공"); //중복아니라서 true 추가 성공
		}else {
			System.out.println("고소영 계좌는 중복계좌입니다");//중복이라 false 추가 안돼
		}
		
		
		boolean a = accountServiceArrayList.addAccount(new Account(1001, "이소라", 30000, 3.3));
...
//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ			
		...
		findAccounts=accountServiceArrayList.findByVip(70000);
