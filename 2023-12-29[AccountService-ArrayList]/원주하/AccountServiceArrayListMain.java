...
public class AccountServiceArrayListMain {
	...
	public static void main(String[] args) {
		...
		accountServiceArrayList.getAccountList();
		System.out.println("0.AccountServiceArrayList야 은행계좌추가해줘");
		Account addAccount = new Account(1111, "고소영", 89000, 0.5);
		...
		Account updateAccount1 = new Account(6666, "HIYAHIYAO", 900000000, 0.4);
