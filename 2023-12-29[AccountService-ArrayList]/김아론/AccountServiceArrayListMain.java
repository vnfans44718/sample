...
public class AccountServiceArrayListMain {
	...
	public static void main(String[] args) {
		...
		ArrayList<Account> findAim=accountServiceArrayList.findByName("AIM");
		for (Account account : findAim) {
			account.print();
		}
		/*
		...
		ArrayList<Account>findVip=accountServiceArrayList.findByBalance(70000);
		System.out.println(findVip.size());
