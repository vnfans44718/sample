...
public class MemberMethod {
	...
	public void method3(int no) {
		System.out.println("public void method3(int no)실행 --> " + no);
	}
	 ...
	 *   - 매개변수  : 문자열,정수(2개) 
	 	 - 구현내용  : 인자로받은데이타 2개출력 
	 */
	public void method3(String str, int no) {
		System.out.println("public void method3(String str, int no)실행 --> " + str + ", " + no);
	}
