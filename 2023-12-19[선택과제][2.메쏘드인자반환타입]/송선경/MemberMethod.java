...
public class MemberMethod {
	...
	public void method3(int x) { 
		System.out.println("인자로 받은 데이타 값: " + x);
	}
	/*
	 * 메쏘드선언
	 *   - 메쏘드이름: method4
	 ...
	 *   - 매개변수  : 문자열,정수(2개) 
	 	 - 구현내용  : 인자로받은데이타 2개출력 
	 */
	public void method4(String y, int z) { 
		System.out.println("인자로 받은 데이타 값: " + y + z);
	 ...
	 *   - 구현내용  : 인자로받은데이타 3개출력 
	 */
	public void method5(String i, String j, int k) { 
		System.out.println("인자로 받은 데이타 값: " + i + j + k);
