...
public class MemberMethod {
	 ...
	 *   - 매개변수  : 문자열,정수(2개) 
	 	 - 구현내용  : 인자로받은데이타 2개출력 
	 */
	public void method4(String stringM4, int intM4) {
		System.out.println(stringM4 + "\t" + intM4);
	}
	 ...
	 *   - 구현내용  : 인자로받은데이타 3개출력 
	 */
	public void method5(String stringM5N1, String stringM5N2, int intM5) {
		System.out.println(stringM5N1 + "\t" + stringM5N2 + "\t" + intM5);
	}
