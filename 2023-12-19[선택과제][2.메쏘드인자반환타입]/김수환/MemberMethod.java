...
public class MemberMethod {
	...
	public void method3(int a) {
		...
		System.out.println("public void method3(int a)실행: " + a);
	}
	 ...
	 *   - 매개변수  : 문자열,정수(2개) 
	 	 - 구현내용  : 인자로받은데이타 2개출력 
	 */
	public void method4(String string, int i) {

		System.out.println("public void method3(String string,int i )실행: " + string + "\t" + i);
	}
	 ...
	 *   - 구현내용  : 인자로받은데이타 3개출력 
	 */
	public void method5(String string,String string2, int i) {

		System.out.println("public void method3(String string,int i )실행: " + string + "\t" + string2+ "\t" +i);
	}
