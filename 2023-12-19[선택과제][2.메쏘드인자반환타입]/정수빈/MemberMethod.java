...
public class MemberMethod {
	...
	public void method3(int a) {
		System.out.println("인자로받은데이타 1개출력 : "+a);
	}
	/*
	 * 메쏘드선언
	 *   - 메쏘드이름: method4
	...
	public void method4(String name, int no1) {
		System.out.println("인자로받은데이타 2개출력 : "+name+" "+no1);
	}
	/*
	 * 메쏘드선언
	 *   - 메쏘드이름: method5
	 ...
	 *   - 구현내용  : 인자로받은데이타 3개출력 
	 */
	public void method5(String str1, String str2, int no1) {
		System.out.println("인자로받은데이타 3개출력 : "+str1+" "+str2+" "+no1);
	}
