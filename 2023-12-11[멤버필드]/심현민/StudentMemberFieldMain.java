...
public class StudentMemberFieldMain {
	...
	public static void main(String[] args) {
		...
		studentMember1.avg = (double) (studentMember1.kor + studentMember1.math+ studentMember1.eng) / 3;
		studentMember2.avg = (double) (studentMember2.kor + studentMember2.math + studentMember2.eng) / 3;
