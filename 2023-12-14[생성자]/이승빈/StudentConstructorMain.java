...
public class StudentConstructorMain {
	...
	public static void main(String[] args) {
		...
		student1.setStudentData(1, "유학렬", 89, 55, 70);

		Student student2 = new Student(2, "학유렬", 46, 52, 99);
		Student student3 = new Student(3, "렬유학", 89, 92, 100);
		...
		System.out.println();
		System.out.println();
		student1.setName("유유학렬");
		System.out.println("student1 이름 변경 후 출력: " + student1.getName());
		System.out.println("student1 총점 데이타: " + student1.getTot());
		System.out.println("student1 학점 데이타: " + student1.getGrade());
